...
export const taskStyles = [
  ...
  rule('.icon-button.danger', 'text-[var(--vscode-errorForeground,_#f85149)]'),
  rule('.icon-button.danger:hover:not(:disabled)', 'text-[var(--vscode-errorForeground,_#ff6b6b)] bg-[rgba(248,_81,_73,_0.12)] border-color-[rgba(248,_81,_73,_0.35)]'),
  ...
  rule('.filter-dialog-backdrop, .markdown-dialog-backdrop', 'fixed inset-[0] z-[20] flex items-center justify-center p-[24px] bg-[rgba(0,_0,_0,_0.54)]'),
  ...
  rule('.filter-dialog-header, .markdown-dialog-header', 'flex items-start justify-between gap-[16px] border-b-[1px_solid_var(--vscode-panel-border)]'),
